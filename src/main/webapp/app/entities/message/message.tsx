  ...
  return (
    <div>
      <h2 id="message-heading" data-cy="MessageHeading">
        <Translate contentKey="jwebpipelineApp.message.home.title">Messages</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jwebpipelineApp.message.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jwebpipelineApp.message.home.createLabel">Create new Message</Translate>
          </Link>
        </div>
      </h2>
          ...
          {messageList && messageList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="jwebpipelineApp.message.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('receivedAt')}>
                    <Translate contentKey="jwebpipelineApp.message.receivedAt">Received At</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="jwebpipelineApp.message.home.notFound">No Messages found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
